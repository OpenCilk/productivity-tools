...
function(get_cilktools_install_dir arch install_dir)
  if(LLVM_ENABLE_PER_TARGET_RUNTIME_DIR AND NOT APPLE)
    ...
    set(${install_dir} ${CILKTOOLS_INSTALL_PATH}/lib/${target} PARENT_SCOPE)
  else()
    set(${install_dir} ${CILKTOOLS_LIBRARY_INSTALL_DIR} PARENT_SCOPE)
  endif()
endfunction()
...
function(get_cilktools_output_dir arch output_dir)
  if(LLVM_ENABLE_PER_TARGET_RUNTIME_DIR AND NOT APPLE)
    get_cilktools_target(${arch} target)
    set(${output_dir} ${CILKTOOLS_OUTPUT_DIR}/lib/${target} PARENT_SCOPE)
  else()
    set(${output_dir} ${CILKTOOLS_LIBRARY_OUTPUT_DIR} PARENT_SCOPE)
  endif()
endfunction()
