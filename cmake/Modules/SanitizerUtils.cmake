...
set(SANITIZER_GEN_DYNAMIC_LIST
  ${CILKTOOLS_SOURCE_DIR}/lib/sanitizer_common/scripts/gen_dynamic_list.py)

set(SANITIZER_LINT_SCRIPT
  ${CILKTOOLS_SOURCE_DIR}/lib/sanitizer_common/scripts/check_lint.sh)
...
macro(add_sanitizer_rt_symbols name)
  ...
  foreach(arch ${ARG_ARCHS})
    ...
    get_cilktools_install_dir(${arch} install_dir)
...
function(add_weak_symbols libname link_flags)
  set(weak_symbols_file "${CILKTOOLS_SOURCE_DIR}/lib/${libname}/weak_symbols.txt")
...
if(CMAKE_HOST_UNIX AND NOT OS_NAME MATCHES "OpenBSD")
  add_custom_target(SanitizerLintCheck
    COMMAND env LLVM_CHECKOUT=${LLVM_MAIN_SRC_DIR} SILENT=1 TMPDIR=
      ...
      CILKTOOLS=${CILKTOOLS_SOURCE_DIR}
