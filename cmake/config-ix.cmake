...
if(APPLE)
  ...
  list_intersect(CILKSCALE_SUPPORTED_ARCH
    ...
    CILKTOOLS_COMMON_SUPPORTED_ARCH)
  list_intersect(CILKGRAPH_SUPPORTED_ARCH
    ALL_CILKGRAPH_SUPPORTED_ARCH
    CILKTOOLS_COMMON_SUPPORTED_ARCH)
  ...
  filter_available_targets(CILKGRAPH_SUPPORTED_ARCH ${ALL_CILKGRAPH_SUPPORTED_ARCH})
endif()
...
if (CILKGRAPH_SUPPORTED_ARCH AND
    OS_NAME MATCHES "Linux|Darwin|FreeBSD")
  set(CILKTOOLS_HAS_CILKGRAPH TRUE)
else()
  set(CILKTOOLS_HAS_CILKGRAPH FALSE)
endif()
